...
public class RigidModel2D extends AbstractAffineModel2D< RigidModel2D >
{
	 ...
	 * @param ty
	 */
	final public void set( final double theta, final double tx, final double ty )
	{
		set( Math.cos( theta ), Math.sin( theta ), tx, ty );
	}
	 ...
	 * @param ty
	 */
	final public void set( final double cos, final double sin, final double tx, final double ty )
	{
		this.cos = cos;
		this.sin = sin;
		this.tx = tx;
