...
import preibisch_imagelib2.view.ExtendedRandomAccessibleInterval;
				...
				threads[ i ] = new Thread( "Morphology erode thread " + i )
				{
					...
					public void run()
					{
						...
						for ( long steps = 0; steps < chunk.getLoopSize(); steps++ )
						{
							...
							@SuppressWarnings( "unchecked" )
							final Neighborhood< BitType > neighborhood = (preibisch_imagelib2.algorithm.neighborhood.Neighborhood< BitType > ) tmp3;
